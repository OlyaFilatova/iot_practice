...
### other
- [ ] Add links to check for changes or ideas
- [ ] start reading papers (examples for gRPC):
    - https://papers.ssrn.com/searchresults.cfm?term=gRPC
    - https://www.researchgate.net/search?q=grpc
    - https://dl.acm.org/action/doSearch?AllField=grpc
